...
namespace DataBase
{
    public class Utils
    {
        ...
        public static string UniqueShortUrl()
        {
            ...
            string sql = "SELECT COUNT(*) FROM url WHERE ShortUrl = @ShortUrl";
            Params p = new Params();
        ...
        public static void AddUrlToDatabase(Url oShortUrl)
        {
            string sql = "INSERT INTO url (ShortUrl, Url, UserId, CreateDate) VALUES (@ShortUrl, @real_url, @created_by, @create_date)";
            Params p = new Params();
        ...
        public static Url RetrieveUrlFromDatabase(string internal_url)
        {
            Url oShortUrl = new Url();
            oShortUrl.ShortenedUrl = internal_url;

            string sql = "SELECT * FROM url WHERE ShortUrl = @ShortUrl";
            Params p = new Params();
            p.Add("@ShortUrl", Clean(internal_url));
